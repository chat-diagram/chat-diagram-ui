...
export default function Payment() {
  ...
  const durations = [
    ...
    { months: 3, price: 36 },
    { months: 6, price: 72 },
    { months: 12, price: 130, recommended: true },
  ];

  const benefits = [
    ["无限对话次数", "GPT-4 模型支持", "高级AI绘画功能"],
    ["流程图生成", "思维导图生成", "自定义提示词"],
    ["API 访问支持", "团队协作功能", "优先客服支持"],
  ];
  ...
  return (
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        {/* Price Display */}
        <Card className="p-8 text-center bg-white shadow-lg rounded-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button
              ...
              className={`h-auto py-3 ${
                selectedPayment === "alipay" ? "bg-black hover:bg-gray-800" : ""
              }`}
        ...
        <Card className="p-6 bg-white shadow-lg rounded-2xl">
          <div className="space-y-4">
            <div className="flex justify-between text-sm">
              <span>商品名称</span>
              <span>chat-diagram ({selectedDuration}个月)</span>
            </div>
